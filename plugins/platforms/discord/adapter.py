...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def _build_slash_event(self, interaction: discord.Interaction, text: str) -> MessageEvent:
        ...
        # Thread parent channel id — needed so per-channel bindings (toolsets,
        # skills, prompts, the /build write-gate) resolve via parent fallback for
        # slash commands invoked inside a thread, matching the on_message path.
